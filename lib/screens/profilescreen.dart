          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Wrap(
                  ...
                  children: <Widget>[
                    RaisedButton.icon(
                      ...
                      onPressed: () => Navigator.pushNamed(context, GridViewScreen.routName),
                      icon: Icon(
                        Icons.grid_on,
                        color: Colors.black,
                      ),
                    ...
                    RaisedButton.icon(
                      padding: EdgeInsets.all(10),
                      onPressed: () => Navigator.pushNamed(context, ListViewScreen.routName),
                      icon: Icon(
                        Icons.list,
                        color: Colors.black,
                      ),
                    ...
                    RaisedButton.icon(
                      padding: EdgeInsets.all(10),
                      onPressed: () => Navigator.pushNamed(context, SlideShowScreen.routName),
                      icon: Icon(
                        Icons.slideshow,
                        color: Colors.black,
                      ),
                ...
                Wrap(
                  children: <Widget>[
                    Container(color: Colors.black, height: 140.0, width: 170, child: Image.network(
